...
public class MdStatusBar {
     ...
     */
    @TargetApi(Build.VERSION_CODES.KITKAT)
    private static void setColorBar(Activity act, @ColorInt int statusColor, int statusDepth, boolean applyNav, @ColorInt int navColor, int navDepth) {
     ...
     */
    @TargetApi(Build.VERSION_CODES.KITKAT)
    private static void setTransparentBar(Activity act, @ColorInt int statusColor, int statusAlpha, boolean applyNav, @ColorInt int navColor, int navAlpha) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            Window window = act.getWindow();
