...
import com.ggz.baselibrary.retrofit.cookie.NetCacheInterceptor;
import com.ggz.baselibrary.retrofit.cookie.OfflineCacheInterceptor;
...
//        return DES3GsonConverterFactory.create();//使用 自定义 GsonConverter
    ...
    OkHttpClient getClient(HttpLoggingInterceptor interceptor, Interceptor header) {
        File httpCacheDirectory = new File(FileUtils.getDiskCacheDir(ConfigUtils.getAppCtx()), "okhttpCache");
