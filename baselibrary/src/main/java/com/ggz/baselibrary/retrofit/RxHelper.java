...
import com.ggz.baselibrary.application.BaseActivityBean;
...
public class RxHelper {
    ...
    public static <T> ObservableTransformer<BeanModule<T>, T> handleResult() {
        return new ObservableTransformer<BeanModule<T>, T>() {
            @Override
            public ObservableSource<T> apply(Observable<BeanModule<T>> upstream) {
                ...
                return upstream.takeUntil(
                        finalSubject.filter(new Predicate<String>() {
                            ...
                            public boolean test(String anObject) throws Exception {
                                ...
                                return ConstantUtils.DESTROY.equals(anObject);
                            }
                        })
                );
            }
